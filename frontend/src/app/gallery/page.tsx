...
const showcaseItems = [
  ...
  { title: "Necklace — Lifestyle Scene", desc: "Jewelry placed in a warm, lifestyle context automatically by AI.", img: "/images/necklace-model.png", category: "Lifestyle", metal: "Gold" },
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-12">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/jewelry" className="px-5 py-2 bg-[#0a0a0a] text-white text-[13px] font-semibold rounded-full hover:bg-[#1a1a1a] transition-all">Start Creating</Link>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-12 py-16 md:py-24 text-center relative">
          ...
          <div className="relative z-10">
            ...
            <h1 className="font-display font-extrabold text-white uppercase tracking-[-0.03em] text-[2rem] sm:text-[3rem] md:text-[4rem] leading-[0.95] mb-5">
              AI Jewelry Photography<br /><span className="text-[#c4a67d]">In Action</span>
            </h1>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-12 py-16 md:py-24 text-center relative">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/jewelry" className="px-8 py-4 bg-white text-[#0a0a0a] text-[14px] font-semibold rounded-full hover:bg-white/90 transition-all active:scale-[0.97] shadow-lg">Try It Free</Link>
