        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-12 py-10 md:py-14">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-10">
            ...
            {[
              ...
              { title: "Resources", links: [{ l: "Pricing", h: "/pricing" }, { l: "Blog", h: "/blog" }, { l: "Tutorial", h: "#" }, { l: "API Docs", h: "#" }] },
              { title: "Company", links: [{ l: "About", h: "#" }, { l: "Contact", h: "#" }, { l: "Privacy Policy", h: "#" }, { l: "Terms of Service", h: "#" }] },
            ].map((col) => (
              <div key={col.title}>
