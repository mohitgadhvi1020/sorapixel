  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setActiveResult(0);
      } else setError(data.error || "Generation failed. No tokens were deducted.");
    } catch (e: unknown) {
      stopProgress(false);
              ...
              <Card padding="none">
                ...
                <div className="p-4 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="secondary" size="sm" onClick={() => downloadImage(active.base64, `soraipixel-catalogue-${Date.now()}.png`)}>
