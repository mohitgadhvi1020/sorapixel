...
export const metadata: Metadata = {
  ...
  description: "SoraiPixel is an AI product photography platform built to help sellers get studio-quality product images instantly. Learn about our mission and team.",
  alternates: { canonical: "/about" },
  openGraph: {
    title: "About SoraiPixel — AI Product Photography",
    description: "Learn about SoraiPixel, the AI-powered platform transforming product photography.",
    url: `${SITE_URL}/about`,
    siteName: "SoraiPixel",
    type: "website",
  },
    ...
    <div className="min-h-screen bg-[#f7f7f5]">
      ...
      <main className="max-w-[900px] mx-auto px-4 sm:px-8 py-12 md:py-20">
        ...
        <h1 className="font-display font-bold text-[#0a0a0a] text-[2rem] md:text-[2.5rem] tracking-tight mb-6">
          Making Professional Product Photography<br />Accessible to Every Seller
        </h1>
        ...
        <div className="space-y-8 text-[#4a4a4a] text-[15px] leading-relaxed">
          <section>
            ...
            <p>Professional product photography costs thousands of rupees per product. Small businesses and independent sellers are forced to choose between expensive studio photoshoots and low-quality phone photos that don&apos;t do their craftsmanship justice.</p>
            <p className="mt-3">A stunning handcrafted product photographed on a kitchen table looks nothing like the same product in a professional catalog. Yet that phone photo is often all a customer sees before deciding to buy — or scroll past.</p>
          </section>

          <section>
            <h2 className="font-display font-bold text-[#0a0a0a] text-[1.25rem] mb-3">Our Solution</h2>
            <p>SoraiPixel uses AI specifically built for product photography to transform any product photo — even a phone snap or CAD render — into studio-quality imagery in under 30 seconds. Hero shots, lifestyle scenes, model photos, close-ups — all from a single upload.</p>
            <p className="mt-3">The key difference from generic AI tools: we never alter your product design. Every detail stays exactly as you designed it. Only the background, lighting, and presentation change.</p>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
              <div className="bg-white rounded-xl p-5 border border-[#e8e5df]">
                <h3 className="font-display font-bold text-[#0a0a0a] text-[15px] mb-2">Independent Sellers</h3>
                <p className="text-[13px] text-[#8c8c8c]">From local workshops to international studios — creators who need professional images without professional budgets.</p>
              </div>
              <div className="bg-white rounded-xl p-5 border border-[#e8e5df]">
          ...
          <section>
            ...
            <div className="space-y-3 mt-4">
              {[
                "Zero design changes — your product stays untouched, guaranteed.",
                ...
                "Continuous improvement — we ship updates weekly based on seller feedback.",
              ].map((point) => (
        ...
        <div className="mt-12 text-center">
          <Link href="/studio" className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#0a0a0a] text-white text-[14px] font-semibold rounded-full hover:bg-[#1a1a1a] transition-all active:scale-[0.97]">
            Try SoraiPixel Free
