    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 sm:gap-4">
          ...
          <button
            type="button"
            onClick={(e) => { e.preventDefault(); e.stopPropagation(); cameraRef.current?.click(); }}
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-[#c4a67d] bg-[rgba(196,166,125,0.1)] hover:bg-[rgba(196,166,125,0.2)] border border-[rgba(196,166,125,0.2)] transition-all"
          >
