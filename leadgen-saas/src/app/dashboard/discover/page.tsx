    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-fade-in">
      <div>
        ...
        <p className="text-text-secondary text-sm">
          Search for businesses matching your ideal customer profile. AI will
          ...
          <div className="mt-6 pt-6 border-t border-border-light">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={source}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-secondary text-xs font-medium text-text-secondary border border-border/50"
                >
          ...
          <div className="max-w-lg mx-auto mb-6">
            ...
            {progress > 0 && (
              <div className="w-full bg-border/50 rounded-full h-2">
                <div
                  className="bg-gradient-primary h-2 rounded-full progress-stripe transition-all duration-300"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-text-secondary">
                Sorted by quality score. Click a prospect to see full research.
              </p>
            </div>
            <button
